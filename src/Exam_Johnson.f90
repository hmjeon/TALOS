...
module Exam_Johnson
    ...
    public Exam_Johnson_Gyroelongated_Pentagonal_Pyramid_J11        ! V=11, E=25, F=16
    public Exam_Johnson_Triangular_Bipyramid_J12                    ! V=5,  E=9,  F=6
    public Exam_Johnson_Pentagonal_Bipyramid_J13                    ! V=7,  E=15, F=10
    public Exam_Johnson_Gyroelongated_Square_Bipyramid_J17          ! V=10, E=24, F=16
    public Exam_Johnson_Square_Gyrobicupola_J29                     ! V=16, E=32, F=18
    public Exam_Johnson_Pentagonal_Orthocupolarotunda_J32           ! V=25, E=50, F=27
    public Exam_Johnson_Pentagonal_Orthobirotunda_J34               ! V=30, E=60, F=32
    public Exam_Johnson_Elongated_Pentagonal_Gyrobicupola_J39       ! V=30, E=60, F=32
    public Exam_Johnson_Elongated_Pentagonal_Gyrobirotunda_J43      ! V=40, E=80, F=42
    public Exam_Johnson_Gyroelongated_Square_Bicupola_J45           ! V=24, E=56, F=34

    public Exam_Johnson_Pentagonal_Pyramid_J2                       ! V=6,  E=10, F=6
    public Exam_Johnson_Elongated_Square_Bipyramid_J15              ! V=10, E=20, F=12
