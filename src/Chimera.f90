...
! ---------------------------------------------------------------------------------------
    ...
    type :: ChimType
        ...
        logical :: run_cylinder1        !  7. Basepair_Chimera_Cylinder,       "_04_cylinder_1.bild"
        logical :: run_cylinder2        !  8. Basepair_Chimera_Cylinder,       "_05_cylinder_2.bild"
        ...
        logical :: run_atom_nick        ! 24. SeqDesign_Chimera_Atom,          "_09_atom_model.bild"
...
subroutine Chimera_Command_Output(prob)
    ...
    chim.run_atom_nick      = para_write_702    ! 24. SeqDesign_Chimera_Atom,          "_09_atom_model.bild"
    ...
    open(unit = 107, file = trim(path)//"_04_cylinder_1.py",     form = "formatted")
    open(unit = 108, file = trim(path)//"_05_cylinder_2.py",     form = "formatted")
    ...
    open(unit = 124, file = trim(path)//"_09_atom_model.py",     form = "formatted")
    ...
    do i = 101, 129
        ...
        if(i == 107) write(i, "(a)"), "runCommand('open "//trim(path)//"_04_cylinder_1.bild')"
        if(i == 108) write(i, "(a)"), "runCommand('open "//trim(path)//"_05_cylinder_2.bild')"
        ...
        if(i == 124) write(i, "(a)"), "runCommand('open "//trim(path)//"_09_atom_model.bild')"
    ...
    if(chim.run_cylinder1      == .true.) write(1001, "(a)"), trim(path)//"_04_cylinder_1.py"
    if(chim.run_cylinder2      == .true.) write(1001, "(a)"), trim(path)//"_05_cylinder_2.py"
    ...
    if(chim.run_atom_nick      == .true.) write(1001, "(a)"), trim(path)//"_09_atom_model.py"
...
subroutine Chimera_Make_Python_Figure(prob, chim)
    ...
    do i = 1, 29
        ...
        else if(i ==  7 .and. chim.run_cylinder1      == .true.) then; des = "_04_cylinder_1"
        else if(i ==  8 .and. chim.run_cylinder2      == .true.) then; des = "_05_cylinder_2"
        ...
        else if(i == 24 .and. chim.run_atom_nick      == .true.) then; des = "_09_atom_model"
