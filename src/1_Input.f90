...
subroutine Input_Initialize_Report(prob, geom, mesh, i, sec, edge, char_vert, char_cut)
    ...
    para_write_303   = .true.        ! *Modified geometry seperated from vertex, "_03_sep_line.bild"
    ...
    para_write_504   = .true.        ! *Multiple lines,                          "_04_six_edged_lines.bild"
    ...
    para_chimera_504_info = .true.   ! *Plot with edge and point number (_04_six_edged_lines.bild)
