...
module Para
    ...
    character(10)  :: para_vertex_design                ! [mitered, flat], Vertex design
    character(10)  :: para_mitered_method  = "new"      ! [new, old], Mitered method
    ...
    character(10) :: para_un_depend_angle  = "off"      ! [off, on], The addition of the unpaired nucleotide depending on the angle between two edges
    ...
    integer   :: para_pos_nick_scaf        = 1          ! [1, 2, 3] Sectional position for the scaffold nick
    ...
    logical :: para_write_502   = .true.        ! *Cylindrical model,                       Basepair_Chimera_Cylinder,        "_04_cylinder_1.bild", "_05_cylinder_2.bild"
    logical :: para_write_503   = .false.       !  Basepair model,                          Basepair_Chimera_Mesh,            "_mesh.bild"
    logical :: para_write_504   = .true.        ! *Multiple line,                           Basepair_Chimera_Cross_Geometry,  "_06_multi_line.bild"
    ...
    logical :: para_write_702   = .true.        ! *Atomic model with sequence design,       SeqDesign_Chimera_Atom,           "_09_atom_model.bild"
