...
module Para
    ...
    logical :: para_write_803   = .true.        ! *CanDo input file,                       ".cndo"
    ...
    logical :: para_chimera_102_info = .true.   ! *Plot with edge and point number (_01_target_geometry.bild)
    logical :: para_chimera_301_info = .false.  !  Plot with edge and point number (_check_geo.bild)
    logical :: para_chimera_302_info = .true.   ! *Plot with edge and point number (_02_target_geometry_local.bild)
